...
//  exit;
    ...
    if ($dado['status']=='success'){
      $produto = $dado["produtos"];
    }
    if(!empty($produto["imagem"])){
      $img = $comp."../".$produto["imagem"];
    }
  }
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Unidade</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" id="nome" name="nome" value="<?php echo $produto ? $produto["nome"] : "" ?>" class="form-control" placeholder="Nome do produto">
                    </div>
                    <div class="form-group">	
                      <label for="preco">Preço</label>
                      <input type="text" id="preco" name="preco" value="<?php echo $produto ? $produto["preco"] : "" ?>" class="form-control" placeholder="Preço do produto">
                    </div>
                    <div class="form-group">
