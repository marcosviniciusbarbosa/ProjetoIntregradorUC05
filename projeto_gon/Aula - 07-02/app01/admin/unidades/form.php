<?php
  ...
  if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    if ($dado['status']=='success'){
      $unidade = $arrUnidades['unidade'];
      $arrUnidades = $dado["unidades"];
    }else{
      $status ="fail";
      $msg = $dado['error'];
                ...
                <form action="salvar.php" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" id="unidade" name="unidade" value="<?php echo $unidade ?>" class="form-control" placeholder="Unidade">
                    </div>
                  </div>
